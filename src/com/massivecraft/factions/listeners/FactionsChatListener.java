...
// since bukkit can support multiple listeners of the same type,
// this implements both of the Faction Chat listeners into one class.
//   * FactionsChatEarlyListener.onPlayerChat() --> FactionsChatListener.onPlayerEarlyChat()
//   * FactionsPlayerListener.onPlayerChat()    --> FactionsChatListener.onPlayerChat()
//
public class FactionsChatListener implements Listener
{
	...
	// previously known as: FactionsChatEarlyListener.onPlayerChat()
	...
	// previously known as: FactionsPlayerListener.onPlayerChat()
