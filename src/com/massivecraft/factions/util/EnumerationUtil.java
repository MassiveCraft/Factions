...
public class EnumerationUtil
{
	...
	public static final BackstringSet<Material> MATERIALS_TRUSTED_CANT_BREAK = new BackstringSet<>(Material.class,
	...
	public static boolean isMaterialTrustedCantBreak(Material material)
	{
		return MATERIALS_TRUSTED_CANT_BREAK.contains(material) || MConf.get().materialsTrustedCantBreak.contains(material);
	}

	public static final BackstringSet<Material> MATERIALS_TRUSTED_CANT_PLACE = new BackstringSet<>(Material.class,
		"OBSIDIAN", // Minecraft 1.?
		"TNT", // Minecraft 1.5
		"MONSTER_EGG", // Minecraft 1.5
		"FLINT_AND_STEEL", // Minecraft 1.5
	...
	public static boolean isMaterialTrustedCantPlace(Material material)
	{
		return MATERIALS_TRUSTED_CANT_PLACE.contains(material) || MConf.get().materialsTrustedCantPlace.contains(material);
	}
